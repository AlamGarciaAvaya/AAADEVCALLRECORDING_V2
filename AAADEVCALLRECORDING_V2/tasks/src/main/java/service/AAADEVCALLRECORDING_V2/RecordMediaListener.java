...
public class RecordMediaListener implements MediaListener {
	private final Logger log = LoggerFactory
			.getLogger(RecordMediaListener.class);
	private Map<UUID, Participant> uuidMap;
	private Map<UUID, String> uuidCallIdMap;
	public Call call;
	private NodeInstance nodeInstance;
	public String dominio;
	public UUID uuidCalled;
	public MediaService mediaServiceCalled;

	public RecordMediaListener(String dominio, Call call, UUID uuidCalled, MediaService mediaServiceCalled) {
		this.mediaServiceCalled = mediaServiceCalled;
		this.uuidCalled = uuidCalled;
		this.call = call;
	...
	public void recordCompleted(UUID requestId, RecordOperationCause cause) {
		...
		mediaServiceCalled.stop(call.getCalledParty(), audioName.uuidCalled);
...
//			mediaServiceCalled.stop(call.getCalledParty(), audioName.uuidCalled);
			...
			meta.addValue("recordingUUID", requestId.toString());
				...
				if (RecordOperationCause.FAILED.equals(cause)) {
					...
					output.put("url", "https://" + separateDominio[2].toString()
